...
const autenticacon_1 = require("../middlewares/autenticacon");
...
postRoutes.post('/upload', [autenticacon_1.verificaToken], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.files) {
...
//Crear POST
postRoutes.post('/', [autenticacon_1.verificaToken], (req, res) => {
    const body = req.body;
